 ...
 */
	...
	public function getInfosGestionnaire($login, $mdp){
		$req = "select id,prenom,nom from gestionnaires where login = '$login' and mdp ='$mdp'";
    	$rs = $this->monPdo->query($req);
		$ligne = $rs->fetch();
		return $ligne;
	}
...
/**            --------------------GESTIONNAIRE---------------------
 *  ----fonction qui recupere les visiteur pour notre liste deroulantes :-----
 */
	...
	public function selectionneFicheVisiteur($idVisiteur){
		// $pdf = PDF::loadView('listeVisiteurs');
 ...
 */
	...
	public function getDateEmbaucheVisiteur($id){
